...
function SlidingRotatingCross() {
    return (
        <div className="sr-animation-container">
            <div className="b_dot"><img className="sr-anim-element" src={b_dot} alt="b_dot"/></div>
            <div className="r_dot"><img className="sr-anim-element" src={r_dot} alt="b_dot"/></div>
            <div className="cross"><img className="sr-anim-element" src={cross} alt="b_dot"/></div>
        </div>
    );
}
